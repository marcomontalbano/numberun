...
public class Monster
{
    ...
    /*
    public int _iPlayerAvatarX
    {
        get
        {
            return iPlayerAvatarX;
        }
        set
        {
            iPlayerAvatarX = value;
        }
    }
    */
    public int iPlayerAvatarY;
    /*
    public int _iPlayerAvatarY
    {
        get
        {
            return iPlayerAvatarY;
        }
        set
        {
            iPlayerAvatarY = value;
        }
    }
    */
    ...
    private bool vGestisciCollisione(int Ylast, int Xlast, int iDir)
    {
        ...
        if ((iCollisioneDaControllare == 002) || (iCollisioneDaControllare == 003) ||
            (iCollisioneDaControllare == 004) || (iCollisioneDaControllare == 005) ||
            (iCollisioneDaControllare == 006) || (iCollisioneDaControllare == 007) ||
            (iCollisioneDaControllare == 008) || (iCollisioneDaControllare == 009) ||
            (iCollisioneDaControllare == 010) || (iCollisioneDaControllare == 011))
        {
            bMovimentoConsentito = false;
        }

        // Caso di collisione cotro 1.ostacoli, 2.crystal potion, 3.porta
        if ((iCollisioneDaControllare == 024) ||    // Ostacoli
        ...
        if (iCollisioneDaControllare == 013)
        {
    ...
    public void vMuoviPersonaggio(double gameTimeSeconds)
    {
        ...
        if (elapsed > iVelocity)
        {
            ...
            if (mov ==  1)
            {
                ...
                if (vGestisciCollisione((iPlayerAvatarY) - 1, (iPlayerAvatarX), 0) == true)
                {
                    if (iPlayerAvatarY > 0)
                    {
                        // Cancello immagine precedente
                        VariabiliGlobali.Globals.myMaps.iMapTrans[iPlayerAvatarY, iPlayerAvatarX] = 000;

                        // Stampo immagine in postazione nuova
                        iPlayerAvatarY -= 1;
                        VariabiliGlobali.Globals.myMaps.iMapTrans[iPlayerAvatarY, iPlayerAvatarX] = iNumeroMostro + 002;
            ...
            {
                // Controllo dell'eventuale collisione
                if (vGestisciCollisione((iPlayerAvatarY) + 1, (iPlayerAvatarX), 1) == true)
                {
            ...
            {
                // Controllo dell'eventuale collisione
                if (vGestisciCollisione((iPlayerAvatarY), (iPlayerAvatarX) - 1, 3) == true)
                {
                    if (iPlayerAvatarX > 0)
                    {
                        // Cancello immagine precedente
            ...
            {
                // Controllo dell'eventuale collisione
                if (vGestisciCollisione((iPlayerAvatarY), (iPlayerAvatarX) + 1, 2) == true)
                {
