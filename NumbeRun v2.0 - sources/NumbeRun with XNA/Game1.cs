...
namespace NumbeRun
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        {
            // Inizializza la musica del gioco
            Music.Initialize();
        ...
        protected override void LoadGraphicsContent(bool loadAllContent)
        {
            if (loadAllContent)
            {
                ...
                rTarg = new RenderTarget2D(VariabiliGlobali.Globals.graphics.GraphicsDevice, 1024, 1024,
                0, SurfaceFormat.Color);
                bloomTarg = new RenderTarget2D(VariabiliGlobali.Globals.graphics.GraphicsDevice, 256, 256,
                    0, SurfaceFormat.Color);

                bloomatic = VariabiliGlobali.Globals.content.Load<Effect>(@"fx/suneffect");
                ...
                case VariabiliGlobali.Globals.GameState.StateMainMenu:
                    {
                        ...
                        Music.Stop(VariabiliGlobali.Globals.cueGameOver);

                        // Musica del menù del gioco
                        VariabiliGlobali.Globals.cueMenu = Music.PlayLoop("Menu01", VariabiliGlobali.Globals.cueMenu);
                ...
                case VariabiliGlobali.Globals.GameState.StatePlaying:
                    {
                        ...
                        // Stoppa la musica del menù del gioco
                        Music.Stop(VariabiliGlobali.Globals.cueMenu);

                        // Musica dei livelli del gioco
                        VariabiliGlobali.Globals.cueLevels = Music.PlayLoop(VariabiliGlobali.Globals.vRandomMusic(), VariabiliGlobali.Globals.cueLevels);
                ...
                case VariabiliGlobali.Globals.GameState.StateGameOver:
                    {
                        ...
                        // Musica dei livelli del gioco
                        VariabiliGlobali.Globals.cueGameOver = Music.PlayLoop("CreditiFinali", VariabiliGlobali.Globals.cueGameOver);
                ...
                case VariabiliGlobali.Globals.GameState.StatePlaying:
                    {
                        ...
                        /// </summary>
                        int iTileToDraw;
                        VariabiliGlobali.Globals.graphics.GraphicsDevice.Clear(Color.Black);

                        // Impostazione per l'offuscamento in caso di PAUSA
                        if (VariabiliGlobali.Globals.bGamePause == true)
                        {
                            VariabiliGlobali.Globals.graphics.GraphicsDevice.SetRenderTarget(0, rTarg);
                            VariabiliGlobali.Globals.graphics.GraphicsDevice.Clear(Color.Black);
                        }


                        // INIZIO ZONA DA OFFUSCARE IN CASO DI PAUSA

                        /*
                         * TRUCCO:
                         * scrivere -> .Begin(SpriteBlendMode.Additive)
                         * Questo permette di vedere oltre agli oggetti!
                        */
                        VariabiliGlobali.Globals.spriteBatch.Begin(SpriteBlendMode.AlphaBlend);
                        ...
                        VariabiliGlobali.Globals.spriteBatch.End();
                        //end FINE ZONA DA OFFUSCARE IN CASO DI PAUSA

                        // Offuscamento in caso di PAUSA
                        if (VariabiliGlobali.Globals.bGamePause == true)
                        {
                            VariabiliGlobali.Globals.graphics.GraphicsDevice.ResolveRenderTarget(0);

                            VariabiliGlobali.Globals.graphics.GraphicsDevice.SetRenderTarget(0, bloomTarg);
                            ...
                            bloomatic.Begin();
                            VariabiliGlobali.Globals.spriteBatch.Begin(SpriteBlendMode.None, SpriteSortMode.Immediate,
                                SaveStateMode.SaveState);

                            EffectPass pass = bloomatic.CurrentTechnique.Passes[0];
                            pass.Begin();

                            VariabiliGlobali.Globals.spriteBatch.Draw(rTarg.GetTexture(), new Rectangle(0, 0, 256, 256),
                            ...
                            VariabiliGlobali.Globals.graphics.GraphicsDevice.SetRenderTarget(0, null);

                            VariabiliGlobali.Globals.spriteBatch.Begin();
                            VariabiliGlobali.Globals.spriteBatch.Draw(rTarg.GetTexture(), new Rectangle(0, 0, 800, 600),
                                new Rectangle(0, 0, 800, 600), Color.White);
                            VariabiliGlobali.Globals.spriteBatch.End();

                            VariabiliGlobali.Globals.spriteBatch.Begin(SpriteBlendMode.AlphaBlend);

                            VariabiliGlobali.Globals.spriteBatch.Draw(bloomTarg.GetTexture(), new Rectangle(0, 0, 800, 600),
                            Color.White);
                            VariabiliGlobali.Globals.spriteBatch.End();
                        }
                        //end    Offuscamento in caso di PAUSA
