...
#define ManagerName "Game Manager"
#define AppPublisher "RPGames"
#define Version "2.0"
#define VersionInfo "2.0.0.0"

#define OutputDir "Setup NumbeRun"
...
; file audio
Source: "{#Path}NumbeRun_music.xgs"; DestDir: "{app}\"
Source: "{#Path}Sound Bank.xsb"; DestDir: "{app}\"
Source: "{#Path}Wave Bank.xwb"; DestDir: "{app}\"
...
Source: "{#Path}fx\suneffect.xnb"; DestDir: "{app}\fx"
